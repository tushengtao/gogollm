...
class ResponseBase:
    ...
    async def __response(*, res: CustomResponseCode | CustomResponse = None, data: Any | None = None,
        ...
        :return:
        """
        return ResponseModel(code=res.code, msg=res.msg, data=data, success=success)
    ...
    async def success(
        ...
        return await self.__response(res=res, data=data, success=True)
    ...
    async def fail(
        ...
        return await self.__response(res=res, data=data, success=False)
