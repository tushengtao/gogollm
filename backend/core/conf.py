...
class Settings(BaseSettings):
    ...
    # Limiter
    LIMITER_REDIS_PREFIX: str = 'gogollm_limiter'
    ...
    TOKEN_REDIS_PREFIX: str = 'gogollm_token'
    TOKEN_REFRESH_REDIS_PREFIX: str = 'gogollm_refresh_token'
    TOKEN_EXCLUDE: list[str] = [  # JWT / RBAC 白名单
        f'{API_V1_STR}/auth/login',
    ]

    # Log
    LOG_STDOUT_FILENAME: str = 'gogollm_access.log'
    LOG_STDERR_FILENAME: str = 'gogollm_error.log'
    ...
    PERMISSION_REDIS_PREFIX: str = 'gogollm_permission'
    ...
    # Ip location
    IP_LOCATION_REDIS_PREFIX: str = 'gogollm_ip_location'
