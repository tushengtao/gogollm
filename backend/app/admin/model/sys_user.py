...
class User(Base):
    ...
    phone: Mapped[str | None] = mapped_column(String(50), default=None, comment='手机号')
    ...
    # 拥有者 应用 一对多
    owner_apps: Mapped[List['App']] = relationship(init=False, back_populates='owner', lazy="selectin")
    # 拥有者 目录 一对多
    owner_dirs: Mapped[List['Dir']] = relationship(init=False, back_populates='owner')
