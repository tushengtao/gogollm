...
class Dept(Base):
    ...
    phone: Mapped[str | None] = mapped_column(String(25), default=None, comment='手机')
    ...
    # 共享应用部门 多对多
    share_apps: Mapped[List['App']] = relationship(init=False, secondary=ggl_app_dept, back_populates='share_depts', lazy="selectin")
    # 共享目录 部门 多对多
    share_dirs: Mapped[List['Dir']] = relationship(init=False, secondary=ggl_dir_dept, back_populates='share_depts', lazy="selectin")
