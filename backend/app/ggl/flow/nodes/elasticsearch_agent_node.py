...
def get_elasticsearch_agent_node(nodeId, flowState):
    ...
    # es搜索工具
    search_es_tool = ElasticSearchSearchTool()
    # 直接返回结果
    if nodeData["return_direct"]:
        search_es_tool.return_direct = True
    # tool 绑定nodeData
    search_es_tool.bind(**nodeData)
...
"""
    ...
    model_config = {
        ...
        "temperature": nodeData["agent_temperature"],
