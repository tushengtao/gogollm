import logo from '@/assets/imgs/Agent.png';
import NodeBodyCard from '@/pages/Ggl/Flow/components/NodeBodyCard';
import { ReactAgentNodeForm } from '@/pages/Ggl/Flow/nodes/nodeForm/ReactAgentNodeForm';
...
export const ReactAgentNode: React.FC = (node: any) => {
  ...
  const [nodeData, setNodeData] = useState(() => {
    ...
    const nodeName = initNodeData.nodeName || 'React-Agent';
  ...
  return (
    <div style={{ position: 'relative' }}>
      ...
      >
        {/*自定义节点表单*/}
        <ReactAgentNodeForm nodeData={nodeData} setNodeData={setNodeData} />
      </NodeBodyCard>
